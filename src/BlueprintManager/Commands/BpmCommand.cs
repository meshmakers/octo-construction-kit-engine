...
namespace Meshmakers.Octo.BlueprintManager.Commands;

/// <summary>
/// Internal base class for all commands.
/// </summary>
internal abstract class BpmCommand : Command<BpmToolOptions>
{
    private readonly IArgument _verboseArg;

    protected BpmCommand(ILogger<BpmCommand> logger, string commandValue, string commandDescription,
        IOptions<BpmToolOptions> options) : base(logger, commandValue, commandDescription, options)
    {
