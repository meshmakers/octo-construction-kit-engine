...
public class CkGraphDirectedAssociations
{
    ...
    [JsonConstructor]
    public CkGraphDirectedAssociations(ICollection<CkTypeAssociationDto> definedAssociations, CkGraphAssociationInheritance @in,
        CkGraphAssociationInheritance @out)
    {
        DefinedAssociations = definedAssociations;
        In = @in;
        Out = @out;
