...
/// </summary>
public class OctoObjectIdEnumerableConverter : JsonConverter<IEnumerable<OctoObjectId>>
{
    /// <inheritdoc />
    public override IEnumerable<OctoObjectId> Read(ref Utf8JsonReader reader, Type typeToConvert,
    ...
    /// <inheritdoc />
    public override void Write(Utf8JsonWriter writer, IEnumerable<OctoObjectId> value, JsonSerializerOptions options)
    {
