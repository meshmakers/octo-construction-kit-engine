...
internal static class MessageCodes
{
    private static readonly Dictionary<string, OperationMessageTemplate> Templates = new()
    {
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                2,
                "Attribute Id '{ckAttributeId}' of CkTypeId '{ckTypeId}' does not exist. Please check if you have set dependency to the correct construction kit model.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                3,
                "Derived CkTypeId '{derivedCkTypeId}' of CkTypeId '{ckTypeId}' does not exist. Please check if you have set dependency to the correct construction kit model.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                4,
                "CkTypeId '{ckTypeId}' defines unknown association role '{roleId}'. Please check if you have set dependency to the correct construction kit model.",
                new[] { "ckTypeId", "roleId" })
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                5,
                "CkTypeId '{ckTypeId}' defines unknown association role target CkTypeId '{targetCkTypeId}'. Please check if you have set dependency to the correct construction kit model.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                12,
                "CkTypeId '{ckTypeId}' defines AttributeId '{ckAttributeId}' that violates at derived CkTypeId '{derivedCkTypeId}' the unique attribute id constraint.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                13,
                "CkTypeId '{ckTypeId}' defines attribute names '{attributeNames}' by inheritance that violates the unique attribute name constraint.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                14,
                "CkTypeId '{ckTypeId}' defines AssociationRoleId '{ckAssociationId}' to CkTypeId '{targetCkTypeId}' that violates the unique association constraint",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                17,
                "CkTypeId '{ckTypeId}' defines an outgoing AssociationRoleId '{ckAssociationId}' to CkTypeId '{targetCkTypeId}' by inheritance that violates the unique association role id constraint",
                new[] { "ckTypeId", "ckAssociationId", "targetCkTypeId" })
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.FatalError,
                18,
                "CkTypeId '{originCkTypeId}' defines a unknown target CkTypeId '{targetCkTypeId}' for role id '{roleId}'. This may happen because a dependency to another construction kit model is missing.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                20,
                "CkTypeId '{ckTypeId}' defines an outgoing AssociationRoleId '{ckAssociationId}' to CkTypeId '{targetCkTypeId}'. This association is also defined between CkTypeId '{otherCkTypeId}' and target CkTypeId '{otherTargetCkTypeId}'.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                37,
                "CkRecordId '{ckRecordId}' defines attribute name '{attributeName}' that violates the unique attribute name constraint.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                38,
                "CkRecordId '{ckRecordId}' defines AttributeId '{ckAttributeId}' that violates at derived CkRecordId '{derivedCkRecordId}' the unique attribute id constraint.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                40,
                "CkRecordId '{ckRecordId}' defines attribute name '{attributeNames}' by inheritance that violates the unique attribute name constraint.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                41,
                "CkAttributeId '{ckAttributeId}' uses unknown CkRecordId '{ckRecordId}'. This may happen because a dependency to another construction kit model is missing.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                42,
                "Attribute Id '{ckAttributeId}' of CkRecordId '{ckRecordId}' does not exist. Please check if you have set dependency to the correct construction kit model.",
                new[] { "ckAttributeId", "ckRecordId" })
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                43,
                "Derived CkRecordId '{derivedCkRecordId}' of CkRecordId '{ckRecordId}' does not exist. Please check if you have set dependency to the correct construction kit model.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                47,
                "CkTypeId '{originCkTypeId}' defines for role id '{roleId}' an unknown target AttributeId '{targetCkAttributeId}' for CkType '{targetCkTypeId}'.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                48,
                "CkTypeId '{ckTypeId}' defines AssociationRoleId '{ckAssociationId}' that is unknown. This may happen because a dependency to another construction kit model is missing.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                49,
                "CkAssociationRole '{ckAssociationRole}' defines attribute name '{attributeName}' that violates the unique attribute name constraint.",
        ...
        },
        {
            ...
            new OperationMessageTemplate(MessageLevel.Error,
                50,
                "CkAssociationRole '{ckAssociationRole}' defines AttributeIds '{ckAttributeId}' that violates the unique attribute id constraint.",
    ...
    {
        return GetMessage("CkTypeIdAssociationNotUnique", ckTypeId, ckAssociationId, targetCkTypeId);
    }

    internal static OperationMessage CkTypeIdAttributeNameNotUnique(object ckTypeId, object attributeName)
    {
        return GetMessage("CkTypeIdAttributeNameNotUnique", ckTypeId, attributeName);
    }

    internal static OperationMessage CkTypeIdAttributeIdNotUnique(object ckTypeId, object ckAttributeId)
    {
        return GetMessage("CkTypeIdAttributeIdNotUnique", ckTypeId, ckAttributeId);
    }

    internal static OperationMessage CkTypeIdOutAssociationNotUniqueByInheritance(object ckTypeId, object ckAssociationId,
        object targetCkTypeId)
    {
        return GetMessage("CkTypeIdOutAssociationNotUniqueByInheritance", ckTypeId, ckAssociationId, targetCkTypeId);
    }

    internal static OperationMessage CkTypeIdUnknownTargetCkTypeIdForAssociation(object originCkTypeId, object targetCkTypeId,
        object roleId)
    {
        return GetMessage("CkTypeIdUnknownTargetCkTypeIdForAssociation", originCkTypeId, targetCkTypeId, roleId);
    }

    internal static OperationMessage CkTypeIdUnknown(object ckTypeId)
    {
        return GetMessage("CkTypeIdUnknown", ckTypeId);
    }

    internal static OperationMessage CkTypeIdMultipleOutgoingAssociationRepresentingSameRole(object ckTypeId, object ckAssociationId,
        object targetCkTypeId, object otherCkTypeId, object otherTargetCkTypeId)
    {
        return GetMessage("CkTypeIdMultipleOutgoingAssociationRepresentingSameRole", ckTypeId, ckAssociationId, targetCkTypeId,
            otherCkTypeId, otherTargetCkTypeId);
    }

    internal static OperationMessage DerivedFromCkTypeIdThatIsFinal(object baseCkTypeId, object derivedTypeId)
    {
        return GetMessage("DerivedFromCkTypeIdThatIsFinal", baseCkTypeId, derivedTypeId);
    }

    internal static OperationMessage DirectoryMustBeEmpty(object directory)
    {
        return GetMessage("DirectoryMustBeEmpty", directory);
    }

    internal static OperationMessage ModelIdContainsInvalidCharacters(object modelId)
    {
        return GetMessage("ModelIdContainsInvalidCharacters", modelId);
    }

    internal static OperationMessage CkTypeIdContainsInvalidCharacters(object ckTypeId)
    {
        return GetMessage("CkTypeIdContainsInvalidCharacters", ckTypeId);
    }

    internal static OperationMessage CkAttributeIdContainsInvalidCharacters(object ckAttributeId)
    {
        return GetMessage("CkAttributeIdContainsInvalidCharacters", ckAttributeId);
    }

    internal static OperationMessage CkAssociationIdContainsInvalidCharacters(object ckAssociationId)
    {
        return GetMessage("CkAssociationIdContainsInvalidCharacters", ckAssociationId);
    }
    ...
    {
        return GetMessage("DirectoryDoesNotExist", directoryPath);
    }

    internal static OperationMessage FileDoesNotExist(object filePath)
    {
        return GetMessage("FileDoesNotExist", filePath);
    }

    internal static OperationMessage SelectionValueNotUnique(object ckEnumId, object key)
    {
        return GetMessage("SelectionValueNotUnique", ckEnumId, key);
    }

    internal static OperationMessage CkRecordIdUndefined(object ckAttributeId)
    {
        return GetMessage("CkRecordIdUndefined", ckAttributeId);
    }

    internal static OperationMessage CkRecordIdContainsInvalidCharacters(object ckRecordId)
    {
        return GetMessage("CkRecordIdContainsInvalidCharacters", ckRecordId);
    }

    internal static OperationMessage RecordIdNotUnique(object ckRecordId)
    {
        return GetMessage("RecordIdNotUnique", ckRecordId);
    }

    internal static OperationMessage CkRecordIdUnknown(object ckRecordId)
    {
        return GetMessage("CkRecordIdUnknown", ckRecordId);
    }

    internal static OperationMessage UnknownCkRecordIdForInheritance(object ckRecordId)
    {
        return GetMessage("UnknownCkRecordIdForInheritance", ckRecordId);
    }

    internal static OperationMessage DerivedFromCkRecordIdThatIsFinal(object baseCkRecordId, object derivedCkRecordId)
    {
        return GetMessage("DerivedFromCkRecordIdThatIsFinal", baseCkRecordId, derivedCkRecordId);
    }

    internal static OperationMessage CkRecordIdAttributeNameNotUnique(object ckRecordId, object attributeName)
    {
        return GetMessage("CkRecordIdAttributeNameNotUnique", ckRecordId, attributeName);
    }

    internal static OperationMessage CkRecordIdAttributeIdNotUniqueByInheritance(object ckRecordId, object ckAttributeId,
        object derivedCkRecordId)
    {
        return GetMessage("CkRecordIdAttributeIdNotUniqueByInheritance", ckRecordId, ckAttributeId, derivedCkRecordId);
    }

    internal static OperationMessage CkRecordIdAttributeIdNotUnique(object ckRecordId, object ckAttributeId)
    {
        return GetMessage("CkRecordIdAttributeIdNotUnique", ckRecordId, ckAttributeId);
    }

    internal static OperationMessage CkRecordIdAttributeNameNotUniqueByInheritance(object ckRecordId, object attributeNames)
    {
        return GetMessage("CkRecordIdAttributeNameNotUniqueByInheritance", ckRecordId, attributeNames);
    }

    internal static OperationMessage AttributeUsesUnknownCkRecordId(object ckAttributeId, object ckRecordId)
    {
        return GetMessage("AttributeUsesUnknownCkRecordId", ckAttributeId, ckRecordId);
    }

    internal static OperationMessage UnknownAttributeOfCkRecordIdInSource(object ckAttributeId, object ckRecordId)
    {
        return GetMessage("UnknownAttributeOfCkRecordIdInSource", ckAttributeId, ckRecordId);
    }

    internal static OperationMessage UnknownDerivedFromCkRecordIdInSource(object derivedCkRecordId, object ckRecordId)
    {
        return GetMessage("UnknownDerivedFromCkRecordIdInSource", derivedCkRecordId, ckRecordId);
    }

    internal static OperationMessage CkEnumIdContainsInvalidCharacters(object ckEnumId)
    {
        return GetMessage("CkEnumIdContainsInvalidCharacters", ckEnumId);
    }

    internal static OperationMessage EnumIdNotUnique(object ckEnumId)
    {
        return GetMessage("EnumIdNotUnique", ckEnumId);
    }

    internal static OperationMessage CkEnumIdUndefined(object ckAttributeId)
    {
        return GetMessage("CkEnumIdUndefined", ckAttributeId);
    }

    internal static OperationMessage CkTypeIdUnknownTargetAttributeIdForAssociation(object originCkTypeId, object roleId,
        object targetCkAttributeId, object targetCkTypeId)
    {
        return GetMessage("CkTypeIdUnknownTargetAttributeIdForAssociation", originCkTypeId, roleId, targetCkAttributeId, targetCkTypeId);
    }

    internal static OperationMessage CkTypeIdAssociationRoleIdUnknown(object ckTypeId, object ckAssociationId)
    {
        return GetMessage("CkTypeIdAssociationRoleIdUnknown", ckTypeId, ckAssociationId);
    }

    internal static OperationMessage CkAssociationRoleAttributeNameNotUnique(object ckAssociationRole, object attributeName)
    {
        return GetMessage("CkAssociationRoleAttributeNameNotUnique", ckAssociationRole, attributeName);
    }

    internal static OperationMessage CkAssociationRoleAttributeIdNotUnique(object ckAssociationRole, object ckAttributeId)
    {
        return GetMessage("CkAssociationRoleAttributeIdNotUnique", ckAssociationRole, ckAttributeId);
    }

    internal static OperationMessage CkAttributeIdNotFoundAtType(object ckAttributeId, object ckTypeId)
    {
        return GetMessage("CkAttributeIdNotFoundAtType", ckAttributeId, ckTypeId);
    }
}