...
internal interface IElementResolver
{
    ...
    /// </summary>
    /// <param name="modelRootBase">The construction kit model root to resolve</param>
    ...
    void Resolve(CkModelRootBase modelRootBase, CkModelGraph ckModelGraph, IVariableResolver variableResolver, IOriginFileResolver originFileResolver,
