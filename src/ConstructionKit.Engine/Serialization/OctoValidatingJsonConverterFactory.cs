...
/// <summary>
///     Represents a JSON converter factory that creates <see cref="T:System.Text.Json.Serialization.JsonConverter`1" /> instances that use
///     JSON Schema to validate the JSON.
/// </summary>
public class OctoValidatingJsonConverterFactory : JsonConverterFactory
{
    ...
    /// <returns>
    ///     An instance of a <see cref="T:System.Text.Json.Serialization.JsonConverter`1" /> where `T` is compatible with
