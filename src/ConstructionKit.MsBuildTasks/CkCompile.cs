...
public class CkCompile : Microsoft.Build.Utilities.Task
{
    ...
    {
        CustomLoadContext customLoadContext = new CustomLoadContext(typeof(CompilerService).Assembly.Location);
                            ...
                            else
                            {
                                ...
                                if (PublishCkModel)
                                {
                                    ...
                                    var ckCompiledModelRoot =
                                        await ckSerializer.DeserializeCompiledModelRootAsync(streamReader, compileResult.CompiledModelFile,
                                            operationResult);
