        ...
        CkAttributeGraph ckAttributeGraph)
    {
        switch (ckAttributeGraph.ValueType)
        {
            ...
            case AttributeValueTypesDto.Enum:
                ...
                {
                    sb.AppendLine(
                        $"  public Rt{ckAttributeGraph.ValueCkEnumId.Key.Name.MakeClassName()}Enum? {ckTypeAttributeDto.AttributeName}");
                    sb.AppendLine("  {");
                    sb.AppendLine(
                        $"      get => GetAttributeValueOrDefault<Rt{ckAttributeGraph.ValueCkEnumId.Key.Name.MakeClassName()}Enum>(nameof(" +
                        ckTypeAttributeDto.AttributeName + "));");
                    sb.AppendLine("      set => SetAttributeValue(nameof(" + ckTypeAttributeDto.AttributeName +
                                  "), AttributeValueTypesDto.Int, value);");
                    sb.AppendLine("  }");
            ...
            case AttributeValueTypesDto.Record:
                ...
                {
                    sb.AppendLine(
                        $"  public Rt{ckAttributeGraph.ValueCkRecordId.Key.Name.MakeClassName()}Record? {ckTypeAttributeDto.AttributeName}");
                    sb.AppendLine("  {");
                    sb.AppendLine(
                        $"      get => GetRtRecordAttributeValueOrDefault<Rt{ckAttributeGraph.ValueCkRecordId.Key.Name.MakeClassName()}Record>(nameof(" +
                        ckTypeAttributeDto.AttributeName + "));");
                    sb.AppendLine("      set => SetAttributeValue(nameof(" + ckTypeAttributeDto.AttributeName +
            ...
            case AttributeValueTypesDto.RecordArray:
                ...
                {
                    sb.AppendLine(
                        $"  public IAttributeValueList<Rt{ckAttributeGraph.ValueCkRecordId.Key.Name.MakeClassName()}Record>? {ckTypeAttributeDto.AttributeName}");
                    sb.AppendLine("  {");
                    sb.AppendLine(
                        $"      get => GetRtRecordAttributeValuesOrDefault<Rt{ckAttributeGraph.ValueCkRecordId.Key.Name.MakeClassName()}Record>(nameof(" +
                        ckTypeAttributeDto.AttributeName + "));");
                    sb.AppendLine("      set => SetAttributeValue(nameof(" + ckTypeAttributeDto.AttributeName +
        ...
        switch (ckAttributeGraph.ValueType)
        {
            ...
            case AttributeValueTypesDto.Enum:
                if (ckAttributeGraph.ValueCkEnumId != null)
                {
                    ...
                    sb.AppendLine("  {");
                    sb.AppendLine(
                        $"      get => GetAttributeValue<Rt{ckAttributeGraph.ValueCkEnumId.Key.Name.MakeClassName()}Enum>(nameof(" +
                        ckTypeAttributeDto.AttributeName + "));");
                    sb.AppendLine("      set => SetAttributeValueNonNullable(nameof(" + ckTypeAttributeDto.AttributeName +
                                  "), AttributeValueTypesDto.Int, value);");
                    sb.AppendLine("  }");
            ...
            case AttributeValueTypesDto.Record:
                if (ckAttributeGraph.ValueCkRecordId != null)
                {
                    ...
                    sb.AppendLine("  {");
                    sb.AppendLine(
                        $"      get => GetRtRecordAttributeValue<Rt{ckAttributeGraph.ValueCkRecordId.Key.Name.MakeClassName()}Record>(nameof(" +
                        ckTypeAttributeDto.AttributeName + "));");
                    sb.AppendLine("      set => SetAttributeValueNonNullable(nameof(" + ckTypeAttributeDto.AttributeName +
                                  "), AttributeValueTypesDto.Record, value);");
                    sb.AppendLine("  }");
            ...
            case AttributeValueTypesDto.RecordArray:
                if (ckAttributeGraph.ValueCkRecordId != null)
                {
                    ...
                    sb.AppendLine("  {");
                    sb.AppendLine(
                        $"      get => GetRtRecordAttributeValues<Rt{ckAttributeGraph.ValueCkRecordId.Key.Name.MakeClassName()}Record>(nameof(" +
                        ckTypeAttributeDto.AttributeName + "));");
                    sb.AppendLine("      set => SetAttributeValueNonNullable(nameof(" + ckTypeAttributeDto.AttributeName +
                                  "), AttributeValueTypesDto.RecordArray, value);");
                    sb.AppendLine("  }");
