...
public class NewtonCrsConverter : JsonConverter
{
    ...
    public override object ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
    {
        ...
        if (string.Equals("name", crsType, StringComparison.OrdinalIgnoreCase))
        {
            ...
            if (properties != null && properties.TryGetValue("name", out var nameValue))
            {
                var target = new NamedCRS(nameValue.ToString());
        ...
        else if (string.Equals("link", crsType, StringComparison.OrdinalIgnoreCase))
        {
            ...
            if (properties != null && properties.TryGetValue("href", out var hrefValue))
            {
                var linked = new LinkedCRS(hrefValue.ToString());
