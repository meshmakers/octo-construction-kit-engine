...
public class FeatureCollection : GeoJSONObject, IEqualityComparer<FeatureCollection>, IEquatable<FeatureCollection>
{
    ...
    [Newtonsoft.Json.JsonProperty(PropertyName = "features", Required = Newtonsoft.Json.Required.Always)]
    ...
    IEquatable<FeatureCollection<TProps>>
{
    ...
    [Newtonsoft.Json.JsonProperty(PropertyName = "features", Required = Newtonsoft.Json.Required.Always)]
    [System.Text.Json.Serialization.JsonPropertyName("features")]
    public new List<Feature<IGeometryObject, TProps>> Features { get; private set; }
