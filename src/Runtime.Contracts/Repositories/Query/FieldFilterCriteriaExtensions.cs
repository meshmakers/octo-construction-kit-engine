...
public static class FieldFilterCriteriaExtensions
{
    ...
    public static T FieldContains<T>(this T @this, string attributeName, string comparisonValue)
        where T : FieldFilterCriteria
    {
    ...
    public static T FieldStartsWith<T>(this T @this, string attributeName, string comparisonValue)
        where T : FieldFilterCriteria
    {
    ...
    public static T FieldEndsWith<T>(this T @this, string attributeName, string comparisonValue)
        where T : FieldFilterCriteria
    {
    ...
    /// <param name="attributeName">Name of attribute</param>
    /// <param name="comparisonValue">Comparison value of the field filter</param>
    public static T FieldGreaterThanOrEqual<T>(this T @this, string attributeName, object? comparisonValue)
        where T : FieldFilterCriteria
    {
        @this.AddFieldFilter(attributeName, FieldFilterOperator.GreaterEqualThan, comparisonValue);
        return @this;
    ...
    /// <param name="attributeName">Name of attribute</param>
    /// <param name="comparisonValue">Comparison value of the field filter</param>
    public static T FieldLessThanOrEqual<T>(this T @this, string attributeName, object? comparisonValue)
        where T : FieldFilterCriteria
    {
        @this.AddFieldFilter(attributeName, FieldFilterOperator.LessEqualThan, comparisonValue);
        return @this;
    ...
    public static T FieldBetween<T>(this T @this, string attributeName, object? lowerValue, object? upperValue)
        where T : FieldFilterCriteria
    {
    ...
    /// <param name="this">The field filter collection</param>
    /// <param name="attributeName">Name of attribute</param>
    public static T FieldIsNull<T>(this T @this, string attributeName)
        where T : FieldFilterCriteria
    {
    ...
    /// <param name="this">The field filter collection</param>
    /// <param name="attributeName">Name of attribute</param>
    public static T FieldIsNotNull<T>(this T @this, string attributeName)
        where T : FieldFilterCriteria
    {
    ...
    public static T FieldRegex<T>(this T @this, string attributeName, string pattern)
        where T : FieldFilterCriteria
    {
