...
public interface IRtSerializer
{
    ...
    /// </summary>
    /// <remarks>
    ///     This method bypasses the schema validation because of huge file size and currently there is no way to validate the JSON schema in a
    ///     streaming way (without commercial libraries)
    /// </remarks>
