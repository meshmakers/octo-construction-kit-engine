...
public class CkAttributeIdTests
{
    ...
    {
        var attributeId = new CkAttributeId("Designation-1");
        Assert.Equal("Designation", attributeId.Name);
        Assert.Equal(1u, attributeId.Version);
    }
    ...
    {
        CkAttributeId attributeId = "Designation-1";
        Assert.Equal("Designation", attributeId.Name);
        Assert.Equal(1u, attributeId.Version);
    }
    ...
    {
        var id1 = new CkAttributeId("Designation-1");
        var id2 = new CkAttributeId("Designation-1");
    ...
    {
        var id1 = new CkAttributeId("Designation-1");
        var id2 = new CkAttributeId("Designation-2");
    ...
    {
        var id1 = new CkAttributeId("Designation-2");
        var id2 = new CkAttributeId("Designation-1");
        Assert.Equal(1, id1.CompareTo(id2));
    }
    ...
    {
        var id1 = new CkAttributeId("TestEntity1-1");
        var id2 = new CkAttributeId("TestEntity2-1");
        Assert.Equal(-1, id1.CompareTo(id2));
    }
    ...
    {
        var id1 = new CkAttributeId("TestEntity-1");
        var id2 = new CkAttributeId("TestEntity-2");
    ...
    {
        var id1 = new CkAttributeId("Designation-1");
        var id2 = new CkAttributeId("Description-1");
        Assert.False(id1.Equals(id2));
    }
}