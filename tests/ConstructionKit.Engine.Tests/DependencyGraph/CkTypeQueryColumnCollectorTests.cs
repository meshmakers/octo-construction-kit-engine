...
public class CkTypeQueryColumnCollectorTests
{
    ...
    public void Simple_OK()
    {
        ...
        Assert.Equal<object>(
            ["a", "b", "c", "rtId", "ckTypeId", "rtWellKnownName", "rtCreatedBy", "rtDisplayName", "rtDisplayDescription", "rtVersion", "rtCreationDateTime", "rtChangedDateTime"],
            result.Select(x => x.Path));
        Assert.Equal<object>(["A", "B", "C", "RtId", "CkTypeId", "RtWellKnownName", "RtCreatedBy", "RtDisplayName", "RtDisplayDescription", "RtVersion", "RtCreationDateTime",
    ...
    public void Records_OK()
    {
        ...
        [
            ...
            "myRecord.myAttributeC", "rtId", "ckTypeId", "rtWellKnownName", "rtCreatedBy", "rtDisplayName", "rtDisplayDescription", "rtVersion", "rtCreationDateTime", "rtChangedDateTime"
        ], result.Select(x => x.Path));
        Assert.Equal<object>(
        [
            "MyAttributeA", "MyAttributeB", "MyAttributeC", "MyRecord", "MyAttributeA", "MyRecord", "MyAttributeB",
            "MyRecord", "MyAttributeC", "RtId", "CkTypeId", "RtWellKnownName", "RtCreatedBy", "RtDisplayName", "RtDisplayDescription", "RtVersion", "RtCreationDateTime",
            "RtChangedDateTime"
    ...
    public void Description_SystemAttributes_AreNull()
    {
        ...
        var systemColumns = new[] { "rtId", "ckTypeId", "rtWellKnownName", "rtCreatedBy", "rtDisplayName", "rtDisplayDescription", "rtVersion", "rtCreationDateTime", "rtChangedDateTime" };
