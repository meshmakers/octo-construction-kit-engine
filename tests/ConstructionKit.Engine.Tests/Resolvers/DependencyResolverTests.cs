...
{
    private readonly ICkModelRepositoryManager _repositoryManager;
    ...
    public DependencyResolverTests(ITestOutputHelper output)
    {
        ...
        _repositoryManager = A.Fake<ICkModelRepositoryManager>();
        _originFileResolver = A.Fake<IOriginFileResolver>();
        var repositoryManagerLazy = new Lazy<ICkModelRepositoryManager>(() => _repositoryManager);

        _resolver = new DependencyResolver(loggerFactory.CreateLogger<DependencyResolver>(), repositoryManagerLazy);
    ...
    public async Task HardResolveDependenciesAsync_WithVersionRanges_ReturnsResolvedDependencies()
    {
        ...
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(dependencyVersionRange, null))
            .Returns(new ModelExistingResult { Exists = true, ModelId = expectedModelId });

        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(expectedModelId, _operationResult, null, null))
    ...
    public async Task HardResolveDependenciesAsync_WithCkModelIds_ReturnsResolvedDependencies()
    {
        ...
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(A<CkModelIdVersionRange>._, null))
            .Returns(new ModelExistingResult { Exists = true, ModelId = dependencyModelId });

        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(dependencyModelId, _operationResult, null, null))
            .Returns(expectedModel);
    ...
    public async Task SoftResolveDependenciesAsync_IndirectReferences_OK()
    {
        ...
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(ckModelIdA.ToVersionRange(), null))
            .Returns(new ModelExistingResult { Exists = true, ModelId = ckModelIdA });
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(ckModelIdB.ToVersionRange(), null))
            .Returns(new ModelExistingResult { Exists = true, ModelId = ckModelIdB });
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(ckModelIdC.ToVersionRange(), null))
            .Returns(new ModelExistingResult { Exists = true, ModelId = ckModelIdC });

        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(ckModelIdA, _operationResult, null, null))
            .Returns(expectedModelA);
        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(ckModelIdB, _operationResult, null, null))
            .Returns(expectedModelB);
        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(ckModelIdC, _operationResult, null, null))
    ...
    public async Task SoftResolveDependenciesAsync_IndirectReferences_MissingMultipleIndirectDependency_OK()
    {
        ...
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(ckModelIdC.ToVersionRange(), null))
            .Returns(new ModelExistingResult { Exists = true, ModelId = ckModelIdC });
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(ckModelIdD.ToVersionRange(), null))
            .Returns(new ModelExistingResult { Exists = false, ModelId = null });
        ...
        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(ckModelIdC, _operationResult, null, null))
            .Returns(expectedModelC);
        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(ckModelIdD, _operationResult, null, null))
            .Returns((CkCompiledModelRoot?)null);
        ...
        SoftResolveDependenciesAsync_IndirectReferences_UpdateBasicConstructionKitModel_OK()
    {
        ...
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(ckModelIdA1.ToVersionRange(), null))
            .Returns(new ModelExistingResult { Exists = false, ModelId = null });
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(ckModelIdA2.ToVersionRange(), null))
        ...
        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(ckModelIdA1, _operationResult, null, null))
            .Returns((CkCompiledModelRoot?)null);
        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(ckModelIdA2, _operationResult, null, null))
        ...
        Assert.NotNull(result);
        Assert.Single(result.RootDependencyModelIds);
        Assert.Contains(ckModelIdA1, result.RootDependencyModelIds);
        Assert.Equal(3, result.ResolvedDependentModelIds.Count);
        Assert.Single(result.UnresolvedDependencyModelIds);
    ...
    public async Task HardResolveDependenciesAsync_WithTransitiveDependencies_ResolvesAllDependencies()
    {
        ...
        var rootModel = CreateTestCkModel(rootDependency, new[] { childDependency });
        var childModel = CreateTestCkModel(childDependency);

        A.CallTo(() =>
                _repositoryManager.IsCkModelExistingAsync(
                    A<CkModelIdVersionRange>.That.Matches(r => r.ModelId.Equals(rootDependency.Name)), null))
            .Returns(new ModelExistingResult { Exists = true, ModelId = rootDependency });

        A.CallTo(() =>
                _repositoryManager.IsCkModelExistingAsync(
                    A<CkModelIdVersionRange>.That.Matches(r => r.ModelId.Equals(childDependency.Name)), null))
            .Returns(new ModelExistingResult { Exists = true, ModelId = childDependency });

        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(rootDependency, _operationResult, null, null))
            .Returns(rootModel);

        A.CallTo(() => _repositoryManager.TryLookupCkModelAsync(childDependency, _operationResult, null, null))
            .Returns(childModel);
    ...
    public async Task HardResolveDependenciesAsync_WithSourceIdentifier_PassesSourceIdentifierToRepository()
    {
        ...
        A.CallTo(() => _repositoryManager.IsCkModelExistingAsync(dependencyVersionRange, sourceIdentifier))
            .Returns(new ModelExistingResult { Exists = true, ModelId = expectedModelId });

        A.CallTo(() =>
                _repositoryManager.TryLookupCkModelAsync(expectedModelId, _operationResult, sourceIdentifier, null))
            .Returns(expectedModel);
