...
namespace Meshmakers.Octo.ConstructionKit.Engine.Tests.sampleData.records1_derivedFromDoesNotExist;
    ...
    public static CkCompiledModelRoot Build()
    {
        return new CkCompiledModelRoot
        {
            ...
            Records = new List<CkRecordDto>
            {
                ...
                {
                    RecordId = "Record1",
                    DerivedFromCkRecordId = "Demo/DoesNotExist", // Error here - record does not exist
