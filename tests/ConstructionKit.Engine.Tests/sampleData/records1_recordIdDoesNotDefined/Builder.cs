...
namespace Meshmakers.Octo.ConstructionKit.Engine.Tests.sampleData.records1_recordIdDoesNotDefined;
        ...
        return new CkCompiledModelRoot
        {
            ...
            [
                ...
                new()
                {
                    ...
                    //ValueCkRecordId = "records1/Record2" // Error here - record is not defined
                }
            ],
            Records =
            [
