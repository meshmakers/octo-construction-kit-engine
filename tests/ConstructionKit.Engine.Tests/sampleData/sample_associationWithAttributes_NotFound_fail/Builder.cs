...
namespace Meshmakers.Octo.ConstructionKit.Engine.Tests.sampleData.sample_associationWithAttributes_NotFound_fail;
                ...
                new()
                {
                    ...
                    Associations = new List<CkTypeAssociationDto>
                    {
                        new()
                        {
                            ...
                            TargetAttributes = new List<CkId<CkAttributeId>>
