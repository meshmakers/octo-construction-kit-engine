...
namespace Meshmakers.Octo.ConstructionKit.Engine.Tests.sampleData.sample_assocs_invalidTarget_fail;
        ...
        return new CkCompiledModelRoot
        {
            ...
            [
                ...
                new()
                {
                    ...
                    Associations = [new() { CkRoleId = "sample1/Related", TargetCkTypeId = "System/EntityNotExisting" }]
                }
            ]
        };
    }
