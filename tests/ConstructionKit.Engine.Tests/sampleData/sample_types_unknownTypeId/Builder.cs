...
namespace Meshmakers.Octo.ConstructionKit.Engine.Tests.sampleData.sample_types_unknownTypeId;
    ...
    public static CkCompiledModelRoot Build()
    {
        return new CkCompiledModelRoot
        {
            ...
            Types = new List<CkTypeDto>
            {
                ...
                {
                    TypeId = "Demo2",
                    DerivedFromCkTypeId = "sample1/Demo1NotExisting", // Error here - type does not exist
                    Attributes = new List<CkTypeAttributeDto>
                    {
