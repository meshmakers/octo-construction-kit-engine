...
namespace Meshmakers.Octo.ConstructionKit.Engine.Tests.sampleData.sample_types_unkownAttributeId;
            ...
            Types = new List<CkTypeDto>
            {
                new()
                {
                    ...
                    Attributes = new List<CkTypeAttributeDto>
                    {
                        ...
                        new() { CkAttributeId = "sample1/attribute3NotExisting", AttributeName = "c" } // Error here - attribute does not exist
                    }
                },
                new()
                {
