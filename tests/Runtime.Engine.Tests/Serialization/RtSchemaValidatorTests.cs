...
public class RtSchemaValidatorTests
{
    ...
    public void ValidateModelInJson_ok()
    {
        ...
        string filePath = "sampleData/files/entity-ok.json";
        var stream = File.OpenRead(filePath);
        var operationResult = new OperationResult();
        bool isValid = schemaValidator.ValidateModelInJson(stream, filePath, operationResult);
        Assert.True(isValid);
    ...
    public void ValidateModelInYaml_ok()
    {
        ...
        string filePath = "sampleData/files/entity-ok.yaml";
        var stream = File.OpenRead(filePath);
        var operationResult = new OperationResult();
